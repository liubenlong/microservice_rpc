package com.freedom.rpc.thrift.common.property;
...
public class ServerProperties {
	...
	static {// 静态块里，只加载一次
		...
		props = null;
		// 构造新的对象
		myProperties = new ServerProperties(ip, port, acceptThreads, selectThreads, acceptedQueueSize, workerThreads,
				zkClusterAddress, //
				sessionTimeoutMs, //
				connectionTimeoutMs, //
				scanPackage);
	...
	private ServerProperties(String ip, int port, int aThreads, int sThreads, int qSize, int wThreads, String zkAddress,
